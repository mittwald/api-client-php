...
/**
 * Auto-generated class for de.mittwald.domainNext.TxtRecords.
 *
...
class TxtRecords
{
    ...
    public function withEntries(array $entries): self
    {
        ...
        $validator->validate($entries, self::$internalValidationSchema['properties']['entries']);
    ...
    public function withoutEntries(): self
    {
        $clone = clone $this;
        unset($clone->entries);
     ...
     * @return TxtRecords Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): TxtRecords
    {
