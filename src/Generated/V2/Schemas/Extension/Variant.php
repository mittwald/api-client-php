...
',
    ...
    public function withDescriptionChangeType(VariantDescriptionChangeType $descriptionChangeType): self
    {
        $clone = clone $this;
        $clone->descriptionChangeType = $descriptionChangeType;

        return $clone;
    }

    public function withoutDescriptionChangeType(): self
    {
        $clone = clone $this;
