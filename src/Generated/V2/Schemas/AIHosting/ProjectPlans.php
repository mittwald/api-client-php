...
/**
 * Auto-generated class for de.mittwald.v1.aihosting.ProjectPlans.
 *
...
class ProjectPlans
{
     ...
     * @return ProjectPlans Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): ProjectPlans
    {
        ...
        $plans = array_map(fn (array|object $i): ProjectPlan => ProjectPlan::buildFromInput($i, validate: $validate), $input->{'plans'});
    ...
    public function toJson(): array
    {
        ...
        $output['plans'] = array_map(fn (ProjectPlan $i): array => $i->toJson(), $this->plans);
