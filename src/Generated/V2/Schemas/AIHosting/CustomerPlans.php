...
class CustomerPlans
{
    ...
    public static function buildFromInput(array|object $input, bool $validate = true): CustomerPlans
    {
        ...
        $plans = array_map(fn (array|object $i): CustomerPlan => CustomerPlan::buildFromInput($i, validate: $validate), $input->{'plans'});
    ...
    public function toJson(): array
    {
        ...
        $output['plans'] = array_map(fn (CustomerPlan $i): array => $i->toJson(), $this->plans);
