...
/**
 * Auto-generated class for de.mittwald.v1.aihosting.Profile.
 *
...
class Profile
{
     ...
     * @param string[] $planIds
     */
    public function withPlanIds(array $planIds): self
    {
        $validator = new Validator();
        $validator->validate($planIds, self::$internalValidationSchema['properties']['planIds']);
        if (!$validator->isValid()) {
            throw new InvalidArgumentException($validator->getErrors()[0]['message']);
        }

        $clone = clone $this;
        $clone->planIds = $planIds;
