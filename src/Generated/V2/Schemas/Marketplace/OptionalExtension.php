...
/**
 * Auto-generated class for de.mittwald.v1.marketplace.OptionalExtension.
 *
...
class OptionalExtension
{
     ...
     * @return OptionalExtension Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): OptionalExtension
    {
        ...
        if (isset($input->{'state'})) {
            $state = OptionalExtensionState::from($input->{'state'});
        }
        $support = null;
