...
class Extension
{
     ...
     * @param string[] $tags
     */
    public function __construct(bool $blocked, Context $context, string $contributorId, string $description, bool $disabled, string $id, string $name, bool $published, array $scopes, ExtensionState $state, SubTitle $subTitle, SupportMeta $support, array $tags)
    {
    ...
    public static function buildFromInput(array|object $input, bool $validate = true): Extension
    {
        ...
        $obj = new self($blocked, $context, $contributorId, $description, $disabled, $id, $name, $published, $scopes, $state, $subTitle, $support, $tags);
