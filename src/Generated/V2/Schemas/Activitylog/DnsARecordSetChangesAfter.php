 ...
 */
class DnsARecordSetChangesAfter
{
    /**
    ...
    private DnsARecordSetChangesAfterTtlAlternative2|int|null $ttl = null;
    ...
    public function getTtl(): DnsARecordSetChangesAfterTtlAlternative2|int|null
    {
        return $this->ttl;
    }
    ...
    public function withTtl(DnsARecordSetChangesAfterTtlAlternative2|int $ttl): self
    {
        $clone = clone $this;
        $clone->ttl = $ttl;
     ...
     * @return DnsARecordSetChangesAfter Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): DnsARecordSetChangesAfter
    {
        ...
        if (isset($input->{'ttl'})) {
            $ttl = match (true) {
                ...
                DnsARecordSetChangesAfterTtlAlternative2::tryFrom($input->{'ttl'}) !== null => DnsARecordSetChangesAfterTtlAlternative2::from($input->{'ttl'}),
    ...
    public function toJson(): array
    {
        ...
        if (isset($this->ttl)) {
            $output['ttl'] = match (true) {
                ...
                $this->ttl instanceof DnsARecordSetChangesAfterTtlAlternative2 => ($this->ttl)->value,
            };
        }
    ...
    public function __clone()
    {
        if (isset($this->ttl)) {
            $this->ttl = match (true) {
                is_int($this->ttl), $this->ttl instanceof DnsARecordSetChangesAfterTtlAlternative2 => $this->ttl,
            };
        }
    }
}
