...
class LogEntry
{
        ...
        'properties' => [
            'action' => [
                'anyOf' => [
                    ...
                    [
                        '$ref' => '#/components/schemas/de.mittwald.v1.activitylog.AppInstallationMainDatabaseChanged',
                    ],
                    [
    ...
    public static function buildFromInput(array|object $input, bool $validate = true): LogEntry
    {
        ...
        $action = match (true) {
            ...
            AppInstallationMainDatabaseChanged::validateInput($input->{'action'}, true) => AppInstallationMainDatabaseChanged::buildFromInput($input->{'action'}, validate: $validate),
