...
/**
 * Auto-generated class for de.mittwald.v1.cronjob.ContainerCronjobRequest.
 *
...
class ContainerCronjobRequest
{
    ...
    private ?ContainerTarget $target = null;
    ...
    public function getTarget(): ?ContainerTarget
    {
    ...
    public function withTarget(ContainerTarget $target): self
    {
        $clone = clone $this;
        $clone->target = $target;
     ...
     * @return ContainerCronjobRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): ContainerCronjobRequest
    {
        ...
        if (isset($input->{'target'})) {
            $target = ContainerTarget::buildFromInput($input->{'target'}, validate: $validate);
        }
        $timeZone = null;
