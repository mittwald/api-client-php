...
/**
 * Auto-generated class for de.mittwald.v1.cronjob.ServiceCronjobRequest.
 *
...
class ServiceCronjobRequest
{
    ...
    private ?ServiceTarget $target = null;
    ...
    public function getTarget(): ?ServiceTarget
    {
    ...
    public function withTarget(ServiceTarget $target): self
    {
        $clone = clone $this;
        $clone->target = $target;
     ...
     * @return ServiceCronjobRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): ServiceCronjobRequest
    {
        ...
        if (isset($input->{'target'})) {
            $target = ServiceTarget::buildFromInput($input->{'target'}, validate: $validate);
        }
        $timeZone = null;
