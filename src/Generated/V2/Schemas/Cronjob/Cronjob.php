...
class Cronjob
{
    ...
    private AppInstallationTarget|ServiceTargetResponse|null $target = null;
    ...
    public function __construct(bool $active, string $appId, DateTime $createdAt, string $description, int $failedExecutionAlertThreshold, string $id, string $interval, string $shortId, int $timeout, DateTime $updatedAt)
    {
        $this->active = $active;
        $this->appId = $appId;
    ...
    public function getTarget(): AppInstallationTarget|ServiceTargetResponse|null
    {
        return $this->target;
    }
    ...
    public function withTarget(AppInstallationTarget|ServiceTargetResponse $target): self
    {
        $clone = clone $this;
        $clone->target = $target;
    ...
    public static function buildFromInput(array|object $input, bool $validate = true): Cronjob
    {
        ...
        if (isset($input->{'target'})) {
            $target = match (true) {
                ...
                ServiceTargetResponse::validateInput($input->{'target'}, true) => ServiceTargetResponse::buildFromInput($input->{'target'}, validate: $validate),
        ...
        $obj = new self($active, $appId, $createdAt, $description, $failedExecutionAlertThreshold, $id, $interval, $shortId, $timeout, $updatedAt);
    ...
    public function toJson(): array
    {
        ...
        if (isset($this->target)) {
            $output['target'] = match (true) {
                ($this->target) instanceof AppInstallationTarget, ($this->target) instanceof ServiceTargetResponse => $this->target->toJson(),
            };
        }
    ...
    public function __clone()
    {
        ...
        if (isset($this->target)) {
            $this->target = match (true) {
                ($this->target) instanceof AppInstallationTarget, ($this->target) instanceof ServiceTargetResponse => $this->target,
            };
        }
