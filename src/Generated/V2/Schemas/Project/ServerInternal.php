...
/**
 * Auto-generated class for de.mittwald.v1.project.ServerInternal.
 *
...
class ServerInternal
{
    ...
    private static array $schema = [
        'properties' => [
            ...
            'scaling' => [
                '$ref' => '#/components/schemas/de.mittwald.v1.project.Scaling',
            ],
            'shortId' => [
                'example' => 's-4e7tz3',
                'type' => 'string',
    ...
    public function withScaling(Scaling $scaling): self
    {
        $clone = clone $this;
    ...
    public function withoutScaling(): self
    {
        $clone = clone $this;
        unset($clone->scaling);
     ...
     * @return ServerInternal Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): ServerInternal
    {
        ...
        $scaling = null;
        if (isset($input->{'scaling'})) {
            $scaling = Scaling::buildFromInput($input->{'scaling'}, validate: $validate);
        }
    ...
    public function toJson(): array
    {
        ...
        if (isset($this->scaling)) {
            $output['scaling'] = $this->scaling->toJson();
        }
