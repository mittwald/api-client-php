...
class AppInstallationInternal
{
    ...
    private ?DateTime $processRunningSince = null;
    ...
    public function getProcessRunningSince(): ?DateTime
    {
        return $this->processRunningSince ?? null;
    }
    ...
    public function withProcessRunningSince(DateTime $processRunningSince): self
    {
        $clone = clone $this;
        $clone->processRunningSince = $processRunningSince;

        return $clone;
    }

    public function withoutProcessRunningSince(): self
    {
        $clone = clone $this;
        unset($clone->processRunningSince);
     ...
     * @return AppInstallationInternal Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): AppInstallationInternal
    {
        ...
        $processRunningSince = null;
        if (isset($input->{'processRunningSince'})) {
            $processRunningSince = new DateTime($input->{'processRunningSince'});
        }
        $processes = null;
    ...
    public function toJson(): array
    {
        ...
        if (isset($this->processRunningSince)) {
            $output['processRunningSince'] = ($this->processRunningSince)->format(DateTime::ATOM);
        }
    ...
    {
        if (isset($this->processRunningSince)) {
            $this->processRunningSince = clone $this->processRunningSince;
        }
    }
}
