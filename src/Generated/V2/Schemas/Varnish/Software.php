...
class Software
{
    ...
    {
        $validator = new Validator();
        $validator->validate($settings, self::$internalValidationSchema['properties']['settings']);
        if (!$validator->isValid()) {
            throw new InvalidArgumentException($validator->getErrors()[0]['message']);
        }
    ...
    {
        $validator = new Validator();
        $validator->validate($softwareId, self::$internalValidationSchema['properties']['softwareId']);
        if (!$validator->isValid()) {
            throw new InvalidArgumentException($validator->getErrors()[0]['message']);
        }
    ...
    {
        $validator = new Validator();
        $validator->validate($softwareTemplateId, self::$internalValidationSchema['properties']['softwareTemplateId']);
        if (!$validator->isValid()) {
            throw new InvalidArgumentException($validator->getErrors()[0]['message']);
        }
