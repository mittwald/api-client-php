...
/**
 * Auto-generated class for de.mittwald.v1.order.LeadFyndrTariffChange.
 *
...
class LeadFyndrTariffChange
{
    ...
    public function __construct(string $contractId, int $reservationLimit, int $unlockLimit)
    {
     ...
     * @return LeadFyndrTariffChange Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): LeadFyndrTariffChange
    {
        ...
        $obj = new self($contractId, $reservationLimit, $unlockLimit);
