...
/**
 * Auto-generated class for de.mittwald.v1.order.LeadFyndrOrder.
 *
...
class LeadFyndrOrder
{
    ...
    public function __construct(string $customerId, int $reservationLimit, int $unlockLimit)
    {
     ...
     * @return LeadFyndrOrder Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): LeadFyndrOrder
    {
        ...
        $obj = new self($customerId, $reservationLimit, $unlockLimit);
