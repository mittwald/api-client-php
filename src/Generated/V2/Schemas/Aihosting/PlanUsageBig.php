...
/**
 * Auto-generated class for de.mittwald.v1.aihosting.PlanUsageBig.
 *
...
class PlanUsageBig
{
    ...
    public function __construct(int $available, int $planLimit, int $tariffLimit, int $used)
    {
     ...
     * @return PlanUsageBig Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): PlanUsageBig
    {
        ...
        $obj = new self($available, $planLimit, $tariffLimit, $used);
