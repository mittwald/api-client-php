...
/**
 * Auto-generated class for de.mittwald.v1.lead-finder.TariffOptions.
 *
...
class TariffOptions
{
    ...
    {
        $validator = new Validator();
        $validator->validate($tariffLimit, self::$schema['properties']['tariffLimit']);
        if (!$validator->isValid()) {
            throw new InvalidArgumentException($validator->getErrors()[0]['message']);
        }
    ...
    {
        $validator = new Validator();
        $validator->validate($used, self::$schema['properties']['used']);
        if (!$validator->isValid()) {
            throw new InvalidArgumentException($validator->getErrors()[0]['message']);
        }
