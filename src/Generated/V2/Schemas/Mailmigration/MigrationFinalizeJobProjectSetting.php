...
class MigrationFinalizeJobProjectSetting
{
    ...
    public function withBlacklistEntries(array $blacklistEntries): self
    {
        ...
        $validator->validate($blacklistEntries, self::$internalValidationSchema['properties']['blacklistEntries']);
    ...
    {
        $validator = new Validator();
        $validator->validate($whitelistEntries, self::$internalValidationSchema['properties']['whitelistEntries']);
        if (!$validator->isValid()) {
            throw new InvalidArgumentException($validator->getErrors()[0]['message']);
        }
