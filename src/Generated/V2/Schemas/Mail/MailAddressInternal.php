...
class MailAddressInternal
{
     ...
     * @return MailAddressInternal Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): MailAddressInternal
    {
        ...
        $autoResponder = MailAddressInternalAutoResponder::buildFromInput($input->{'autoResponder'}, validate: $validate);
        ...
        if (isset($input->{'mailbox'})) {
            $mailbox = MailAddressInternalMailbox::buildFromInput($input->{'mailbox'}, validate: $validate);
        }
