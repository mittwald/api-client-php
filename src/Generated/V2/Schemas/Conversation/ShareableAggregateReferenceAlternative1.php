 ...
 * de.mittwald.v1.conversation.ShareableAggregateReferenceAlternative1.
 *
 ...
 */
class ShareableAggregateReferenceAlternative1
{
    /**
     ...
     * @return ShareableAggregateReferenceAlternative1 Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): ShareableAggregateReferenceAlternative1
    {
        ...
        $aggregate = ShareableAggregateReferenceAlternative1Aggregate::from($input->{'aggregate'});
        $domain = ShareableAggregateReferenceAlternative1Domain::from($input->{'domain'});
        $id = $input->{'id'};
