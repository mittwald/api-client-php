...
class ServiceRequestRelocationPayloadTarget
{
    ...
    public function withAccountShortId(string $accountShortId): self
    {
        ...
        $validator->validate($accountShortId, self::$internalValidationSchema['properties']['accountShortId']);
    ...
    {
        $validator = new Validator();
        $validator->validate($application, self::$internalValidationSchema['properties']['application']);
        if (!$validator->isValid()) {
            throw new InvalidArgumentException($validator->getErrors()[0]['message']);
        }
    ...
    {
        $validator = new Validator();
        $validator->validate($articleType, self::$internalValidationSchema['properties']['articleType']);
        if (!$validator->isValid()) {
            throw new InvalidArgumentException($validator->getErrors()[0]['message']);
        }
    ...
    {
        $validator = new Validator();
        $validator->validate($product, self::$internalValidationSchema['properties']['product']);
        if (!$validator->isValid()) {
            throw new InvalidArgumentException($validator->getErrors()[0]['message']);
        }
    ...
    {
        $validator = new Validator();
        $validator->validate($withDataCompare, self::$internalValidationSchema['properties']['withDataCompare']);
        if (!$validator->isValid()) {
            throw new InvalidArgumentException($validator->getErrors()[0]['message']);
        }
