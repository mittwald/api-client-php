...
class ServiceRequestRelocationPayloadSource
{
    ...
    public function withProviderName(string $providerName): self
    {
        ...
        $validator->validate($providerName, static::$schema['properties']['providerName']);
    ...
    {
        $validator = new Validator();
        $validator->validate($providerPassword, static::$schema['properties']['providerPassword']);
        if (!$validator->isValid()) {
            throw new InvalidArgumentException($validator->getErrors()[0]['message']);
        }
    ...
    {
        $validator = new Validator();
        $validator->validate($providerUrl, static::$schema['properties']['providerUrl']);
        if (!$validator->isValid()) {
            throw new InvalidArgumentException($validator->getErrors()[0]['message']);
        }
    ...
    {
        $validator = new Validator();
        $validator->validate($providerUsername, static::$schema['properties']['providerUsername']);
        if (!$validator->isValid()) {
            throw new InvalidArgumentException($validator->getErrors()[0]['message']);
        }
