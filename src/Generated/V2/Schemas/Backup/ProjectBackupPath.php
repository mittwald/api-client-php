...
/**
 * Auto-generated class for de.mittwald.v1.backup.ProjectBackupPath.
 *
...
class ProjectBackupPath
{
     ...
     * @return ProjectBackupPath Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): ProjectBackupPath
    {
        ...
        if (isset($input->{'items'})) {
            $items = array_map(fn (array|object $i): ProjectBackupPath => ProjectBackupPath::buildFromInput($i, validate: $validate), $input->{'items'});
        }
        $name = $input->{'name'};
        $size = (int)($input->{'size'});
        $target = null;
    ...
    public function toJson(): array
    {
        ...
        if (isset($this->items)) {
            $output['items'] = array_map(fn (ProjectBackupPath $i): array => $i->toJson(), $this->items);
        }
