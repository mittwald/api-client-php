...
class PageinsightsGetStraceDataOKResponse implements ResponseContainer
{
    /**
     ...
     * @return PageinsightsGetStraceDataOKResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): PageinsightsGetStraceDataOKResponse
    {
        ...
        $body = PageinsightsGetStraceDataOKResponseBody::buildFromInput($input->{'body'}, validate: $validate);
