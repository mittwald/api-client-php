...
class PageinsightsScheduleStraceRequest
{
     ...
     * @return PageinsightsScheduleStraceRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): PageinsightsScheduleStraceRequest
    {
        ...
        $body = PageinsightsScheduleStraceRequestBody::buildFromInput($input->{'body'}, validate: $validate);
    ...
    public function buildUrl(): string
    {
        ...
        return '/v2/projects/' . $projectId . '/straces';
    }
