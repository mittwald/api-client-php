...
class PageinsightsScheduleStraceAcceptedResponse implements ResponseContainer
{
    /**
     ...
     * @return PageinsightsScheduleStraceAcceptedResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): PageinsightsScheduleStraceAcceptedResponse
    {
        ...
        $body = PageinsightsScheduleStraceAcceptedResponseBody::buildFromInput($input->{'body'}, validate: $validate);
