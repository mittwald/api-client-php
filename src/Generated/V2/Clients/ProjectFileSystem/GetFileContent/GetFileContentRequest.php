...
class GetFileContentRequest
{
    ...
    {
        $validator = new Validator();
        $validator->validate($file, self::$internalValidationSchema['properties']['file']);
        if (!$validator->isValid()) {
            throw new InvalidArgumentException($validator->getErrors()[0]['message']);
        }
    ...
    {
        $validator = new Validator();
        $validator->validate($inline, self::$internalValidationSchema['properties']['inline']);
        if (!$validator->isValid()) {
            throw new InvalidArgumentException($validator->getErrors()[0]['message']);
        }
     ...
     * @return GetFileContentRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): GetFileContentRequest
    {
