...
class CreateMysqlDatabaseCreatedResponse implements ResponseContainer
{
    /**
     ...
     * @return CreateMysqlDatabaseCreatedResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): CreateMysqlDatabaseCreatedResponse
    {
        ...
        $body = CreateMysqlDatabaseCreatedResponseBody::buildFromInput($input->{'body'}, validate: $validate);
