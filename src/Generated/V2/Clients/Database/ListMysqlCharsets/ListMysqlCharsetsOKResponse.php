...
class ListMysqlCharsetsOKResponse implements ResponseContainer
{
    /**
    ...
    private static array $internalValidationSchema = [
        ...
        'properties' => [
            'body' => [
                'items' => [
                    '$ref' => '#/components/schemas/de.mittwald.v1.database.MySqlCharacterSettings',
                ],
                'type' => 'array',
            ],
        ],
     ...
     * @return ListMysqlCharsetsOKResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): ListMysqlCharsetsOKResponse
    {
