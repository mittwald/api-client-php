...
class GetRedisDatabaseOKResponse implements ResponseContainer
{
    /**
     ...
     * @return GetRedisDatabaseOKResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): GetRedisDatabaseOKResponse
    {
        ...
        $body = RedisDatabase::buildFromInput($input->{'body'}, validate: $validate);
