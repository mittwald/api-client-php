...
class CreateRedisDatabaseCreatedResponse implements ResponseContainer
{
    /**
     ...
     * @return CreateRedisDatabaseCreatedResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): CreateRedisDatabaseCreatedResponse
    {
        ...
        $body = CreateRedisDatabaseCreatedResponseBody::buildFromInput($input->{'body'}, validate: $validate);
