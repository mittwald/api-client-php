...
class PatchRedisDatabaseRequest
{
    ...
    private PatchRedisDatabaseRequestBody $body;

    private array $headers = [

    ];

    public function __construct(string $redisDatabaseId, PatchRedisDatabaseRequestBody $body)
    {
    ...
    public function getBody(): PatchRedisDatabaseRequestBody
    {
        return $this->body;
    }
    ...
    public function withBody(PatchRedisDatabaseRequestBody $body): self
    {
        $clone = clone $this;
        $clone->body = $body;
     ...
     * @return PatchRedisDatabaseRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): PatchRedisDatabaseRequest
    {
        ...
        $body = PatchRedisDatabaseRequestBody::buildFromInput($input->{'body'}, validate: $validate);
