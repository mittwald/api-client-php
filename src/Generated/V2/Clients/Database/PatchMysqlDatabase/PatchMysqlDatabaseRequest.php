...
class PatchMysqlDatabaseRequest
{
    ...
    private PatchMysqlDatabaseRequestBody $body;

    private array $headers = [

    ];

    public function __construct(string $mysqlDatabaseId, PatchMysqlDatabaseRequestBody $body)
    {
    ...
    public function getBody(): PatchMysqlDatabaseRequestBody
    {
        return $this->body;
    }
    ...
    public function withBody(PatchMysqlDatabaseRequestBody $body): self
    {
        $clone = clone $this;
        $clone->body = $body;
     ...
     * @return PatchMysqlDatabaseRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): PatchMysqlDatabaseRequest
    {
        ...
        $body = PatchMysqlDatabaseRequestBody::buildFromInput($input->{'body'}, validate: $validate);
