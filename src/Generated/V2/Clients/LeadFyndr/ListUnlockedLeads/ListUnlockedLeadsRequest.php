...
class ListUnlockedLeadsRequest
{
    ...
    private ListUnlockedLeadsRequestSort $sort = ListUnlockedLeadsRequestSort::relevance;

    private ListUnlockedLeadsRequestOrder $order = ListUnlockedLeadsRequestOrder::desc;
    ...
    public function getSort(): ListUnlockedLeadsRequestSort
    {
        return $this->sort;
    }

    public function getOrder(): ListUnlockedLeadsRequestOrder
    {
        return $this->order;
    }
    ...
    {
        $validator = new Validator();
        $validator->validate($reserved, self::$internalValidationSchema['properties']['reserved']);
        if (!$validator->isValid()) {
            throw new InvalidArgumentException($validator->getErrors()[0]['message']);
        }
    ...
    public function withoutReserved(): self
    {
        $clone = clone $this;
        unset($clone->reserved);
    ...
    public function withSort(ListUnlockedLeadsRequestSort $sort): self
    {
        $clone = clone $this;
        $clone->sort = $sort;
    ...
    public function withOrder(ListUnlockedLeadsRequestOrder $order): self
    {
        $clone = clone $this;
        $clone->order = $order;
     ...
     * @return ListUnlockedLeadsRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): ListUnlockedLeadsRequest
    {
        ...
        $sort = ListUnlockedLeadsRequestSort::relevance;
        if (isset($input->{'sort'})) {
            $sort = ListUnlockedLeadsRequestSort::from($input->{'sort'});
        }
        $order = ListUnlockedLeadsRequestOrder::desc;
        if (isset($input->{'order'})) {
            $order = ListUnlockedLeadsRequestOrder::from($input->{'order'});
        }
    ...
    public function buildUrl(): string
    {
        ...
        return '/v2/customers/' . $customerId . '/unlocked-leads';
    }
    ...
    public function buildRequestOptions(): array
    {
        ...
        if (isset($mapped['reserved'])) {
            $query['reserved'] = $mapped['reserved'];
        }
