...
class ListUnlockedLeadsOKResponseBody
{
    /**
     ...
     * @return ListUnlockedLeadsOKResponseBody Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): ListUnlockedLeadsOKResponseBody
    {
        ...
        $leads = array_map(fn (array|object $i): UnlockedLead => UnlockedLead::buildFromInput($i, validate: $validate), $input->{'leads'});
    ...
    {
        $output = [];
        $output['leads'] = array_map(fn (UnlockedLead $i): array => $i->toJson(), $this->leads);
