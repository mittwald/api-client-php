...
class StartServiceRequest
{
     ...
     * @return StartServiceRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): StartServiceRequest
    {
    ...
    public function buildUrl(): string
    {
        ...
        return '/v2/stacks/' . $stackId . '/services/' . $serviceId . '/actions/start';
    }
