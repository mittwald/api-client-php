...
class RecreateServiceRequest
{
     ...
     * @return RecreateServiceRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): RecreateServiceRequest
    {
    ...
    public function buildUrl(): string
    {
        ...
        return '/v2/stacks/' . $stackId . '/services/' . $serviceId . '/actions/recreate';
    }
