...
class ListServicesRequest
{
     ...
     * @return ListServicesRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): ListServicesRequest
    {
    ...
    public function buildUrl(): string
    {
        ...
        return '/v2/projects/' . $projectId . '/services';
    }
