...
class GetTemplateRequest
{
     ...
     * @return GetTemplateRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): GetTemplateRequest
    {
    ...
    public function buildUrl(): string
    {
        ...
        return '/v2/container-templates/' . $templateId;
    }
