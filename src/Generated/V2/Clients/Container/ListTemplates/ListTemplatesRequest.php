...
class ListTemplatesRequest
{
    ...
    public function withType(ListTemplatesRequestType $type): self
    {
        $clone = clone $this;
        $clone->type = $type;
     ...
     * @return ListTemplatesRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): ListTemplatesRequest
    {
