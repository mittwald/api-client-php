...
class GetServiceLogsAnalysisRequest
{
     ...
     * @return GetServiceLogsAnalysisRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): GetServiceLogsAnalysisRequest
    {
    ...
    public function buildUrl(): string
    {
        ...
        return '/v2/stacks/' . $stackId . '/services/' . $serviceId . '/log-analysis';
    }
