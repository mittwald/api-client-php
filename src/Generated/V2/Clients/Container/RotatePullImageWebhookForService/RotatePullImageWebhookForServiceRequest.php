...
class RotatePullImageWebhookForServiceRequest
{
     ...
     * @return RotatePullImageWebhookForServiceRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): RotatePullImageWebhookForServiceRequest
    {
    ...
    public function buildUrl(): string
    {
        ...
        return '/v2/stacks/' . $stackId . '/services/' . $serviceId . '/webhook-token';
    }
