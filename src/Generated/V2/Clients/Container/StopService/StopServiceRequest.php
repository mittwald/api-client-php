...
class StopServiceRequest
{
     ...
     * @return StopServiceRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): StopServiceRequest
    {
    ...
    public function buildUrl(): string
    {
        ...
        return '/v2/stacks/' . $stackId . '/services/' . $serviceId . '/actions/stop';
    }
