...
class ConfirmPasswordResetRequest
{
     ...
     * @return ConfirmPasswordResetRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): ConfirmPasswordResetRequest
    {
        ...
        $body = ConfirmPasswordResetRequestBody::buildFromInput($input->{'body'}, validate: $validate);
