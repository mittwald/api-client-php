...
class DeprecatedUserCreateIssue201Response
{
    ...
    /**
     * @var DeprecatedUserCreateIssue201ResponseBody
     */
    private DeprecatedUserCreateIssue201ResponseBody $body;
     ...
     */
    public function __construct(DeprecatedUserCreateIssue201ResponseBody $body)
    {
        $this->body = $body;
    }
    ...
    public static function buildFromInput(array|object $input, bool $validate = true) : DeprecatedUserCreateIssue201Response
    {
        ...
        $body = DeprecatedUserCreateIssue201ResponseBody::buildFromInput($input->{'body'}, validate: $validate);
