...
class DeprecatedUserCreateIssueCreatedResponse implements ResponseContainer
{
    /**
     ...
     * @return DeprecatedUserCreateIssueCreatedResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): DeprecatedUserCreateIssueCreatedResponse
    {
        ...
        $body = DeprecatedUserCreateIssueCreatedResponseBody::buildFromInput($input->{'body'}, validate: $validate);
