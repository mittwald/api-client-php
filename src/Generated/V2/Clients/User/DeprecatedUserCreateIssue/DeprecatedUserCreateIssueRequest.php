...
class DeprecatedUserCreateIssueRequest
{
     ...
     * @return DeprecatedUserCreateIssueRequest Created instance
     * @throws \InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true) : DeprecatedUserCreateIssueRequest
    {
        ...
        $body = DeprecatedUserCreateIssueRequestBody::buildFromInput($input->{'body'}, validate: $validate);
