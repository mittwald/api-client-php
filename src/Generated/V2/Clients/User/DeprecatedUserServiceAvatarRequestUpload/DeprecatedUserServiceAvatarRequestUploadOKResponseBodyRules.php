...
class DeprecatedUserServiceAvatarRequestUploadOKResponseBodyRules
{
     ...
     * @return DeprecatedUserServiceAvatarRequestUploadOKResponseBodyRules Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): DeprecatedUserServiceAvatarRequestUploadOKResponseBodyRules
    {
        ...
        if (isset($input->{'properties'})) {
            $properties = DeprecatedUserServiceAvatarRequestUploadOKResponseBodyRulesProperties::buildFromInput($input->{'properties'}, validate: $validate);
        }
