...
class DeprecatedUserServiceAvatarRequestUpload200ResponseBodyRulesProperties
{
    ...
    /**
     * @var DeprecatedUserServiceAvatarRequestUpload200ResponseBodyRulesPropertiesImageDimensions|null
     */
    ...
    public static function buildFromInput(array|object $input, bool $validate = true): DeprecatedUserServiceAvatarRequestUpload200ResponseBodyRulesProperties
    {
        ...
        if (isset($input->{'imageDimensions'})) {
            $imageDimensions = DeprecatedUserServiceAvatarRequestUpload200ResponseBodyRulesPropertiesImageDimensions::buildFromInput($input->{'imageDimensions'}, validate: $validate);
        }
