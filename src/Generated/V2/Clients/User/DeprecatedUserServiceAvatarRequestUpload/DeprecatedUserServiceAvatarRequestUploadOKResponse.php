...
class DeprecatedUserServiceAvatarRequestUploadOKResponse implements ResponseContainer
{
    /**
     ...
     * @return DeprecatedUserServiceAvatarRequestUploadOKResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): DeprecatedUserServiceAvatarRequestUploadOKResponse
    {
        ...
        $body = DeprecatedUserServiceAvatarRequestUploadOKResponseBody::buildFromInput($input->{'body'}, validate: $validate);
