...
class ListSshKeysOKResponse implements ResponseContainer
{
    /**
     ...
     * @return ListSshKeysOKResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): ListSshKeysOKResponse
    {
        ...
        $body = ListSshKeysOKResponseBody::buildFromInput($input->{'body'}, validate: $validate);
