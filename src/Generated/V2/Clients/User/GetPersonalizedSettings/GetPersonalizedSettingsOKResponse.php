...
class GetPersonalizedSettingsOKResponse implements ResponseContainer
{
    /**
     ...
     * @return GetPersonalizedSettingsOKResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): GetPersonalizedSettingsOKResponse
    {
        ...
        $body = GetPersonalizedSettingsOKResponseBody::buildFromInput($input->{'body'}, validate: $validate);
