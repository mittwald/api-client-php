...
class OauthRetrieveAccessTokenBadRequestResponse implements ResponseContainer
{
    /**
     ...
     * @return OauthRetrieveAccessTokenBadRequestResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): OauthRetrieveAccessTokenBadRequestResponse
    {
        ...
        $body = OauthRetrieveAccessTokenBadRequestResponseBody::buildFromInput($input->{'body'}, validate: $validate);
