...
class GetMfaStatusOKResponse implements ResponseContainer
{
    /**
     ...
     * @return GetMfaStatusOKResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): GetMfaStatusOKResponse
    {
        ...
        $body = GetMfaStatusOKResponseBody::buildFromInput($input->{'body'}, validate: $validate);
