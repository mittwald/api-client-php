...
class CreateFeedbackCreatedResponse implements ResponseContainer
{
    /**
     ...
     * @return CreateFeedbackCreatedResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): CreateFeedbackCreatedResponse
    {
        ...
        $body = CreateFeedbackCreatedResponseBody::buildFromInput($input->{'body'}, validate: $validate);
