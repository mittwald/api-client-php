...
class ResendVerificationEmailForbiddenResponse implements ResponseContainer
{
    /**
     ...
     * @return ResendVerificationEmailForbiddenResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): ResendVerificationEmailForbiddenResponse
    {
        ...
        $body = ResendVerificationEmailForbiddenResponseBody::buildFromInput($input->{'body'}, validate: $validate);
