...
class ResetRecoverycodesOKResponse implements ResponseContainer
{
    /**
     ...
     * @return ResetRecoverycodesOKResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): ResetRecoverycodesOKResponse
    {
        ...
        $body = ResetRecoverycodesOKResponseBody::buildFromInput($input->{'body'}, validate: $validate);
