...
class CreateApiTokenCreatedResponse implements ResponseContainer
{
    /**
     ...
     * @return CreateApiTokenCreatedResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): CreateApiTokenCreatedResponse
    {
        ...
        $body = CreateApiTokenCreatedResponseBody::buildFromInput($input->{'body'}, validate: $validate);
