...
class AddPhoneNumberForbiddenResponse implements ResponseContainer
{
    /**
     ...
     * @return AddPhoneNumberForbiddenResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): AddPhoneNumberForbiddenResponse
    {
        ...
        $body = AddPhoneNumberForbiddenResponseBody::buildFromInput($input->{'body'}, validate: $validate);
