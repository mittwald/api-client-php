...
class AuthenticateWithAccessTokenRetrievalKeyOKResponse implements ResponseContainer
{
    /**
     ...
     * @return AuthenticateWithAccessTokenRetrievalKeyOKResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): AuthenticateWithAccessTokenRetrievalKeyOKResponse
    {
        ...
        $body = AuthenticateWithAccessTokenRetrievalKeyOKResponseBody::buildFromInput($input->{'body'}, validate: $validate);
