...
class GetSpotlightInfoRequest
{
    ...
    public function __construct(string $spotlightId)
    {
     ...
     * @return GetSpotlightInfoRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): GetSpotlightInfoRequest
    {
