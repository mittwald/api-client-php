...
class EditApiTokenRequest
{
     ...
     * @return EditApiTokenRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): EditApiTokenRequest
    {
        ...
        $body = EditApiTokenRequestBody::buildFromInput($input->{'body'}, validate: $validate);
