...
class SupportCodeRequestOKResponse implements ResponseContainer
{
    /**
     ...
     * @return SupportCodeRequestOKResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): SupportCodeRequestOKResponse
    {
        ...
        $body = SupportCodeRequestOKResponseBody::buildFromInput($input->{'body'}, validate: $validate);
