...
class DeprecatedUserUpdateAccountRequest
{
     ...
     * @return DeprecatedUserUpdateAccountRequest Created instance
     * @throws \InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true) : DeprecatedUserUpdateAccountRequest
    {
        ...
        $body = DeprecatedUserUpdateAccountRequestBody::buildFromInput($input->{'body'}, validate: $validate);
