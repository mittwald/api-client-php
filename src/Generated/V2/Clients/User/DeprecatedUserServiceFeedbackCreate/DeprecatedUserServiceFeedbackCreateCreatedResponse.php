...
class DeprecatedUserServiceFeedbackCreateCreatedResponse implements ResponseContainer
{
    /**
     ...
     * @return DeprecatedUserServiceFeedbackCreateCreatedResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): DeprecatedUserServiceFeedbackCreateCreatedResponse
    {
        ...
        $body = DeprecatedUserServiceFeedbackCreateCreatedResponseBody::buildFromInput($input->{'body'}, validate: $validate);
