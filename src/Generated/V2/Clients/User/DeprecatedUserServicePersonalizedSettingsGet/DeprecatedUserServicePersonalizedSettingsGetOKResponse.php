...
class DeprecatedUserServicePersonalizedSettingsGetOKResponse implements ResponseContainer
{
    /**
     ...
     * @return DeprecatedUserServicePersonalizedSettingsGetOKResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): DeprecatedUserServicePersonalizedSettingsGetOKResponse
    {
        ...
        $body = DeprecatedUserServicePersonalizedSettingsGetOKResponseBody::buildFromInput($input->{'body'}, validate: $validate);
