...
class DeprecatedUserResendVerificationEmailForbiddenResponse implements ResponseContainer
{
    /**
     ...
     * @return DeprecatedUserResendVerificationEmailForbiddenResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): DeprecatedUserResendVerificationEmailForbiddenResponse
    {
        ...
        $body = DeprecatedUserResendVerificationEmailForbiddenResponseBody::buildFromInput($input->{'body'}, validate: $validate);
