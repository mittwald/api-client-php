...
class DeprecatedUserDisableMfaOKResponse implements ResponseContainer
{
    /**
     ...
     * @return DeprecatedUserDisableMfaOKResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): DeprecatedUserDisableMfaOKResponse
    {
        ...
        $body = DeprecatedUserDisableMfaOKResponseBody::buildFromInput($input->{'body'}, validate: $validate);
