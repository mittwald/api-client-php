...
class InitPasswordResetCreatedResponse implements ResponseContainer
{
    /**
     ...
     * @return InitPasswordResetCreatedResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): InitPasswordResetCreatedResponse
    {
        ...
        $body = InitPasswordResetCreatedResponseBody::buildFromInput($input->{'body'}, validate: $validate);
