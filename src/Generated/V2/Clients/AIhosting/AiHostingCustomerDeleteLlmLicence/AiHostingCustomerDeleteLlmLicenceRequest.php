...
class AiHostingCustomerDeleteLlmLicenceRequest
{
    ...
    public function __construct(string $customerId, string $licenceId)
    {
     ...
     * @return AiHostingCustomerDeleteLlmLicenceRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): AiHostingCustomerDeleteLlmLicenceRequest
    {
        ...
        $obj = new self($customerId, $licenceId);
