...
class ExtensionResumeWebhookExecutionForExtensionInstanceRequest
{
    ...
    public function __construct(string $contributorId, string $extensionId, string $extensionInstanceId)
    {
     ...
     * @return ExtensionResumeWebhookExecutionForExtensionInstanceRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): ExtensionResumeWebhookExecutionForExtensionInstanceRequest
    {
        ...
        $obj = new self($contributorId, $extensionId, $extensionInstanceId);
    ...
    public function buildUrl(): string
    {
        ...
        return '/v2/contributors/' . $contributorId . '/extensions/' . $extensionId . '/extension-instances/' . $extensionInstanceId . '/actions/resume-webhook-execution';
    }
