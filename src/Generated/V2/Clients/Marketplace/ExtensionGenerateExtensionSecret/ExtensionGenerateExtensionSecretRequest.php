...
class ExtensionGenerateExtensionSecretRequest
{
     ...
     * @return ExtensionGenerateExtensionSecretRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): ExtensionGenerateExtensionSecretRequest
    {
    ...
    public function buildUrl(): string
    {
        ...
        return '/v2/contributors/' . $contributorId . '/extensions/' . $extensionId . '/secret';
    }
