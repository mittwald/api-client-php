...
class ContributorListIncomingInvoicesRequest
{
     ...
     * @return ContributorListIncomingInvoicesRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): ContributorListIncomingInvoicesRequest
    {
    ...
    public function buildUrl(): string
    {
        ...
        return '/v2/contributors/' . $contributorId . '/invoices/incoming';
    }
