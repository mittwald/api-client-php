...
class ContributorPatchContributorRequest
{
    ...
    private ContributorPatchContributorRequestBody $body;

    private array $headers = [

    ];

    public function __construct(string $contributorId, ContributorPatchContributorRequestBody $body)
    {
    ...
    public function getBody(): ContributorPatchContributorRequestBody
    {
        return $this->body;
    }
    ...
    public function withBody(ContributorPatchContributorRequestBody $body): self
    {
        $clone = clone $this;
        $clone->body = $body;
     ...
     * @return ContributorPatchContributorRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): ContributorPatchContributorRequest
    {
        ...
        $body = ContributorPatchContributorRequestBody::buildFromInput($input->{'body'}, validate: $validate);
    ...
    public function buildUrl(): string
    {
        ...
        return '/v2/contributors/' . $contributorId;
    }
