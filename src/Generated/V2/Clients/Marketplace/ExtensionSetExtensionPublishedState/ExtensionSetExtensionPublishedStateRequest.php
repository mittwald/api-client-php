...
class ExtensionSetExtensionPublishedStateRequest
{
    ...
    private ExtensionSetExtensionPublishedStateRequestBody $body;

    private array $headers = [

    ];

    public function __construct(string $contributorId, string $extensionId, ExtensionSetExtensionPublishedStateRequestBody $body)
    {
    ...
    public function getBody(): ExtensionSetExtensionPublishedStateRequestBody
    {
        return $this->body;
    }
    ...
    public function withBody(ExtensionSetExtensionPublishedStateRequestBody $body): self
    {
        $clone = clone $this;
        $clone->body = $body;
     ...
     * @return ExtensionSetExtensionPublishedStateRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): ExtensionSetExtensionPublishedStateRequest
    {
        ...
        $body = ExtensionSetExtensionPublishedStateRequestBody::buildFromInput($input->{'body'}, validate: $validate);
    ...
    public function buildUrl(): string
    {
        ...
        return '/v2/contributors/' . $contributorId . '/extensions/' . $extensionId . '/published';
    }
