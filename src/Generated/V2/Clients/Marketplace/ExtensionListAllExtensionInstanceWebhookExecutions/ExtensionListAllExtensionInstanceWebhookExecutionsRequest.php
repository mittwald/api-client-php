...
use Mittwald\ApiClient\Generated\V2\Schemas\Marketplace\ExtensionInstanceWebhookExecutionState;
...
class ExtensionListAllExtensionInstanceWebhookExecutionsRequest
{
    ...
    /**
     * @var ExtensionInstanceWebhookExecutionState[]|null
     */
    ...
    /**
     * @return ExtensionInstanceWebhookExecutionState[]|null
     */
    ...
    /**
     * @param ExtensionInstanceWebhookExecutionState[] $state
     */
    ...
    public static function buildFromInput(array|object $input, bool $validate = true): ExtensionListAllExtensionInstanceWebhookExecutionsRequest
    {
        ...
        if (isset($input->{'state'})) {
            $state = array_map(fn (string $i): ExtensionInstanceWebhookExecutionState => ExtensionInstanceWebhookExecutionState::from($i), $input->{'state'});
        }
        $limit = null;
    ...
    public function toJson(): array
    {
        ...
        if (isset($this->state)) {
            $output['state'] = array_map(fn (ExtensionInstanceWebhookExecutionState $i): string => $i->value, $this->state);
        }
        if (isset($this->limit)) {
