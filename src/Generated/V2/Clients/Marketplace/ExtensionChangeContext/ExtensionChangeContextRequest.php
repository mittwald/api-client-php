...
class ExtensionChangeContextRequest
{
    ...
    private ExtensionChangeContextRequestBody $body;

    private array $headers = [

    ];

    public function __construct(string $contributorId, string $extensionId, ExtensionChangeContextRequestBody $body)
    {
    ...
    public function getBody(): ExtensionChangeContextRequestBody
    {
        return $this->body;
    }
    ...
    public function withBody(ExtensionChangeContextRequestBody $body): self
    {
        $clone = clone $this;
        $clone->body = $body;
     ...
     * @return ExtensionChangeContextRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): ExtensionChangeContextRequest
    {
        ...
        $body = ExtensionChangeContextRequestBody::buildFromInput($input->{'body'}, validate: $validate);
    ...
    public function buildUrl(): string
    {
        ...
        return '/v2/contributors/' . $contributorId . '/extensions/' . $extensionId . '/context';
    }
