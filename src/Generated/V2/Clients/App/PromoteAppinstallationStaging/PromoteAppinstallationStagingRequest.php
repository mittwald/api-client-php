...
class PromoteAppinstallationStagingRequest
{
     ...
     * @return PromoteAppinstallationStagingRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): PromoteAppinstallationStagingRequest
    {
    ...
    public function buildUrl(): string
    {
        ...
        return '/v2/app-installations/' . $appInstallationId . '/actions/promote-staging';
    }
