...
class DeleteAppinstallationStagingRequest
{
     ...
     * @return DeleteAppinstallationStagingRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): DeleteAppinstallationStagingRequest
    {
    ...
    public function buildUrl(): string
    {
        ...
        return '/v2/app-installations/' . $appInstallationId . '/staging';
    }
