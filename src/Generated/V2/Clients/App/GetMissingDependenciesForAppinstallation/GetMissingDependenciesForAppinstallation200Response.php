...
class GetMissingDependenciesForAppinstallation200Response
{
    ...
    /**
     * @var GetMissingDependenciesForAppinstallation200ResponseBody
     */
     ...
     */
    public function __construct(GetMissingDependenciesForAppinstallation200ResponseBody $body)
    {
        $this->body = $body;
    }
    ...
    public static function buildFromInput(array|object $input, bool $validate = true) : GetMissingDependenciesForAppinstallation200Response
    {
        ...
        $body = GetMissingDependenciesForAppinstallation200ResponseBody::buildFromInput($input->{'body'}, validate: $validate);
