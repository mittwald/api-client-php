...
class GetMissingDependenciesForAppinstallationOKResponse implements ResponseContainer
{
    /**
     ...
     * @return GetMissingDependenciesForAppinstallationOKResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): GetMissingDependenciesForAppinstallationOKResponse
    {
        ...
        $body = GetMissingDependenciesForAppinstallationOKResponseBody::buildFromInput($input->{'body'}, validate: $validate);
