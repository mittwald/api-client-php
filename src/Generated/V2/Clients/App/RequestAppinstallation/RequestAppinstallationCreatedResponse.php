...
class RequestAppinstallationCreatedResponse implements ResponseContainer
{
    /**
     ...
     * @return RequestAppinstallationCreatedResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): RequestAppinstallationCreatedResponse
    {
        ...
        $body = RequestAppinstallationCreatedResponseBody::buildFromInput($input->{'body'}, validate: $validate);
