...
class GetAppinstallationErrorAnalysisRequest
{
     ...
     * @return GetAppinstallationErrorAnalysisRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): GetAppinstallationErrorAnalysisRequest
    {
    ...
    public function buildUrl(): string
    {
        ...
        return '/v2/app-installations/' . $appInstallationId . '/error-analysis';
    }
