...
class ListArticlesOKResponse implements ResponseContainer
{
    /**
     ...
     * @return ListArticlesOKResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): ListArticlesOKResponse
    {
    ...
    {
        $output = [];
        $output['body'] = array_map(fn (ReadableArticle $i): array => $i->toJson(), $this->body);
