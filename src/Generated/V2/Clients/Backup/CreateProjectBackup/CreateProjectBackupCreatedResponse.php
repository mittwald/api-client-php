...
class CreateProjectBackupCreatedResponse implements ResponseContainer
{
    /**
     ...
     * @return CreateProjectBackupCreatedResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): CreateProjectBackupCreatedResponse
    {
        ...
        $body = ProjectBackup::buildFromInput($input->{'body'}, validate: $validate);
