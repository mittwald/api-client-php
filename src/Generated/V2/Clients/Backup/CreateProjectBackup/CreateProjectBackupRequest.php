...
class CreateProjectBackupRequest
{
     ...
     * @return CreateProjectBackupRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): CreateProjectBackupRequest
    {
        ...
        $body = CreateProjectBackupRequestBody::buildFromInput($input->{'body'}, validate: $validate);
