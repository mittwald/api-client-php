...
use Mittwald\ApiClient\Generated\V2\Schemas\Backup\ProjectBackupRestorePath;
...
class RequestProjectBackupRestorePathRequest
{
    ...
    private ProjectBackupRestorePath $body;

    private array $headers = [

    ];

    public function __construct(string $projectBackupId, ProjectBackupRestorePath $body)
    {
    ...
    public function getBody(): ProjectBackupRestorePath
    {
        return $this->body;
    }
    ...
    public function withBody(ProjectBackupRestorePath $body): self
    {
        $clone = clone $this;
        $clone->body = $body;
    ...
    public static function buildFromInput(array|object $input, bool $validate = true): RequestProjectBackupRestorePathRequest
    {
        ...
        $body = ProjectBackupRestorePath::buildFromInput($input->{'body'}, validate: $validate);
