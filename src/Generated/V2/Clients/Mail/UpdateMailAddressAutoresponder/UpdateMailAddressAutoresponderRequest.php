...
class UpdateMailAddressAutoresponderRequest
{
     ...
     * @return UpdateMailAddressAutoresponderRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): UpdateMailAddressAutoresponderRequest
    {
        ...
        $body = UpdateMailAddressAutoresponderRequestBody::buildFromInput($input->{'body'}, validate: $validate);
