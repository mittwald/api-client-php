...
class UpdateMailAddressCatchAllRequest
{
     ...
     * @return UpdateMailAddressCatchAllRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): UpdateMailAddressCatchAllRequest
    {
        ...
        $body = UpdateMailAddressCatchAllRequestBody::buildFromInput($input->{'body'}, validate: $validate);
    ...
    public function buildUrl(): string
    {
        ...
        return '/v2/mail-addresses/' . $mailAddressId . '/catch-all';
    }
