...
class UpdateMailAddressSpamProtectionRequestBodySpamProtection
{
     ...
     * @return UpdateMailAddressSpamProtectionRequestBodySpamProtection Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): UpdateMailAddressSpamProtectionRequestBodySpamProtection
    {
        ...
        $folder = UpdateMailAddressSpamProtectionRequestBodySpamProtectionFolder::from($input->{'folder'});
