...
class UpdateMailAddressSpamProtectionRequest
{
     ...
     * @return UpdateMailAddressSpamProtectionRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): UpdateMailAddressSpamProtectionRequest
    {
        ...
        $body = UpdateMailAddressSpamProtectionRequestBody::buildFromInput($input->{'body'}, validate: $validate);
