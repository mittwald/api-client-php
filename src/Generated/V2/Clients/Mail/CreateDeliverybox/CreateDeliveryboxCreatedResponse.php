...
class CreateDeliveryboxCreatedResponse implements ResponseContainer
{
    /**
     ...
     * @return CreateDeliveryboxCreatedResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): CreateDeliveryboxCreatedResponse
    {
        ...
        $body = CreateDeliveryboxCreatedResponseBody::buildFromInput($input->{'body'}, validate: $validate);
