...
class DeliveryboxUpdateDescriptionDeprecatedRequest
{
     ...
     * @return DeliveryboxUpdateDescriptionDeprecatedRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): DeliveryboxUpdateDescriptionDeprecatedRequest
    {
        ...
        $id = $input->{'id'};
        $body = DeliveryboxUpdateDescriptionDeprecatedRequestBody::buildFromInput($input->{'body'}, validate: $validate);
