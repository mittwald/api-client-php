...
class DeleteDeliveryBoxRequest
{
    ...
    public function withDeliveryBoxId(string $deliveryBoxId): self
    {
        ...
        $validator->validate($deliveryBoxId, self::$internalValidationSchema['properties']['deliveryBoxId']);
     ...
     * @return DeleteDeliveryBoxRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): DeleteDeliveryBoxRequest
    {
