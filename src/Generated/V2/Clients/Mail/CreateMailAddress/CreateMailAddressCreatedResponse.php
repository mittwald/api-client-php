...
class CreateMailAddressCreatedResponse implements ResponseContainer
{
    /**
     ...
     * @return CreateMailAddressCreatedResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): CreateMailAddressCreatedResponse
    {
        ...
        $body = CreateMailAddressCreatedResponseBody::buildFromInput($input->{'body'}, validate: $validate);
