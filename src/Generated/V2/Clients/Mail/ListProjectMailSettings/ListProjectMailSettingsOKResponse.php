...
class ListProjectMailSettingsOKResponse implements ResponseContainer
{
    /**
     ...
     * @return ListProjectMailSettingsOKResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): ListProjectMailSettingsOKResponse
    {
        ...
        $body = ListProjectMailSettingsOKResponseBody::buildFromInput($input->{'body'}, validate: $validate);
