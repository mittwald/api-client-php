...
class ProjectsettingUpdateBlacklistDeprecatedRequest
{
     ...
     * @return ProjectsettingUpdateBlacklistDeprecatedRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): ProjectsettingUpdateBlacklistDeprecatedRequest
    {
        ...
        $body = ProjectsettingUpdateBlacklistDeprecatedRequestBody::buildFromInput($input->{'body'}, validate: $validate);
