...
class MailaddressUpdateForwardaddressesRequest
{
    ...
    /**
     * @var MailaddressUpdateForwardaddressesRequestBody
     */
     ...
     */
    public function __construct(string $id, MailaddressUpdateForwardaddressesRequestBody $body)
    {
        $this->id = $id;
        $this->body = $body;
    }
    ...
    public static function buildFromInput(array|object $input, bool $validate = true): MailaddressUpdateForwardaddressesRequest
    {
        ...
        $id = $input->{'id'};
        $body = MailaddressUpdateForwardaddressesRequestBody::buildFromInput($input->{'body'}, validate: $validate);
