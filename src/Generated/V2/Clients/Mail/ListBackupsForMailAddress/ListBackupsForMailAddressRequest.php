...
class ListBackupsForMailAddressRequest
{
     ...
     * @return ListBackupsForMailAddressRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): ListBackupsForMailAddressRequest
    {
    ...
    public function buildUrl(): string
    {
        ...
        return '/v2/mail-addresses/' . $mailAddressId . '/backups';
    }
