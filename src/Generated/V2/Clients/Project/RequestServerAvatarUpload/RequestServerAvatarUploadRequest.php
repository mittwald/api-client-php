...
class RequestServerAvatarUploadRequest
{
     ...
     * @return RequestServerAvatarUploadRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): RequestServerAvatarUploadRequest
    {
    ...
    public function buildUrl(): string
    {
        ...
        return '/v2/servers/' . $serverId . '/avatar';
    }
