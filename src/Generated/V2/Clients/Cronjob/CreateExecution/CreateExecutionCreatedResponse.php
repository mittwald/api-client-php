...
class CreateExecutionCreatedResponse implements ResponseContainer
{
    /**
     ...
     * @return CreateExecutionCreatedResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): CreateExecutionCreatedResponse
    {
        ...
        $body = CreateExecutionCreatedResponseBody::buildFromInput($input->{'body'}, validate: $validate);
