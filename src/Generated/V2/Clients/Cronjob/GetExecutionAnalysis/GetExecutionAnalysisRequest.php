...
class GetExecutionAnalysisRequest
{
     ...
     * @return GetExecutionAnalysisRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): GetExecutionAnalysisRequest
    {
    ...
    public function buildUrl(): string
    {
        ...
        return '/v2/cronjobs/' . $cronjobId . '/executions/' . $executionId . '/analysis';
    }
