...
class CreateCronjob201Response
{
    ...
    /**
     * @var CreateCronjob201ResponseBody
     */
     ...
     */
    public function __construct(CreateCronjob201ResponseBody $body)
    {
        $this->body = $body;
    }
    ...
    public static function buildFromInput(array|object $input, bool $validate = true): CreateCronjob201Response
    {
        ...
        $body = CreateCronjob201ResponseBody::buildFromInput($input->{'body'}, validate: $validate);
