...
class CreateCronjobCreatedResponse implements ResponseContainer
{
    /**
     ...
     * @return CreateCronjobCreatedResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): CreateCronjobCreatedResponse
    {
        ...
        $body = CreateCronjobCreatedResponseBody::buildFromInput($input->{'body'}, validate: $validate);
