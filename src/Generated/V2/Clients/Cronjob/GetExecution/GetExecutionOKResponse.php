...
class GetExecutionOKResponse implements ResponseContainer
{
    /**
     ...
     * @return GetExecutionOKResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): GetExecutionOKResponse
    {
        ...
        $body = CronjobExecution::buildFromInput($input->{'body'}, validate: $validate);
