...
class UpdateConversationOKResponse implements ResponseContainer
{
    /**
     ...
     * @return UpdateConversationOKResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): UpdateConversationOKResponse
    {
        ...
        $body = UpdateConversationOKResponseBody::buildFromInput($input->{'body'}, validate: $validate);
