...
class RequestFileUpload201ResponseBodyRules
{
    ...
    /**
     * @var RequestFileUpload201ResponseBodyRulesProperties|null
     */
    ...
    public static function buildFromInput(array|object $input, bool $validate = true): RequestFileUpload201ResponseBodyRules
    {
        ...
        if (isset($input->{'properties'})) {
            $properties = RequestFileUpload201ResponseBodyRulesProperties::buildFromInput($input->{'properties'}, validate: $validate);
        }
