...
class RequestFileUploadCreatedResponseBodyRulesPropertiesImageDimensions implements ResponseContainer
{
    /**
     ...
     * @return RequestFileUploadCreatedResponseBodyRulesPropertiesImageDimensions Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): RequestFileUploadCreatedResponseBodyRulesPropertiesImageDimensions
    {
        ...
        $max = null;
        if (isset($input->{'max'})) {
            $max = RequestFileUploadCreatedResponseBodyRulesPropertiesImageDimensionsMax::buildFromInput($input->{'max'}, validate: $validate);
        }
        $min = null;
        if (isset($input->{'min'})) {
            $min = RequestFileUploadCreatedResponseBodyRulesPropertiesImageDimensionsMin::buildFromInput($input->{'min'}, validate: $validate);
        }
