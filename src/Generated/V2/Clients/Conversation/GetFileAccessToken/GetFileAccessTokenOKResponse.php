...
class GetFileAccessTokenOKResponse implements ResponseContainer
{
    /**
     ...
     * @return GetFileAccessTokenOKResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): GetFileAccessTokenOKResponse
    {
        ...
        $body = GetFileAccessTokenOKResponseBody::buildFromInput($input->{'body'}, validate: $validate);
