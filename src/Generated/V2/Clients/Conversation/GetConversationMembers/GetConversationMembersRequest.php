...
class GetConversationMembersRequest
{
     ...
     * @return GetConversationMembersRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): GetConversationMembersRequest
    {
    ...
    public function buildUrl(): string
    {
        ...
        return '/v2/conversations/' . $conversationId . '/members';
    }
