...
class IngressTlsDeprecatedOKResponse implements ResponseContainer
{
    /**
     ...
     * @return IngressTlsDeprecatedOKResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): IngressTlsDeprecatedOKResponse
    {
        ...
        $body = IngressTlsDeprecatedOKResponseBody::buildFromInput($input->{'body'}, validate: $validate);
