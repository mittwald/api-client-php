...
class ChangeOwnercOfDomainV2DeprecatedOKResponse implements ResponseContainer
{
    /**
     ...
     * @return ChangeOwnercOfDomainV2DeprecatedOKResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): ChangeOwnercOfDomainV2DeprecatedOKResponse
    {
        ...
        $body = ChangeOwnercOfDomainV2DeprecatedOKResponseBody::buildFromInput($input->{'body'}, validate: $validate);
