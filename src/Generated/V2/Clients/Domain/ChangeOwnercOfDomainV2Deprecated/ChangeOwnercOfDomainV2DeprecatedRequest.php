...
class ChangeOwnercOfDomainV2DeprecatedRequest
{
     ...
     * @return ChangeOwnercOfDomainV2DeprecatedRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): ChangeOwnercOfDomainV2DeprecatedRequest
    {
        ...
        $body = ChangeOwnercOfDomainV2DeprecatedRequestBody::buildFromInput($input->{'body'}, validate: $validate);
