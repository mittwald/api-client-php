...
class CheckDomainRegistrabilityV2DeprecatedOKResponse implements ResponseContainer
{
    /**
     ...
     * @return CheckDomainRegistrabilityV2DeprecatedOKResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): CheckDomainRegistrabilityV2DeprecatedOKResponse
    {
        ...
        $body = CheckDomainRegistrabilityV2DeprecatedOKResponseBody::buildFromInput($input->{'body'}, validate: $validate);
