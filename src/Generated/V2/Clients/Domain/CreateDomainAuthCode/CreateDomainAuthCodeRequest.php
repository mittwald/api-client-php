...
class CreateDomainAuthCodeRequest
{
     ...
     * @return CreateDomainAuthCodeRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): CreateDomainAuthCodeRequest
    {
    ...
    public function getUrl(): string
    {
        ...
        return '/v2/domains/' . $domainId . '/actions/auth-code';
    }
