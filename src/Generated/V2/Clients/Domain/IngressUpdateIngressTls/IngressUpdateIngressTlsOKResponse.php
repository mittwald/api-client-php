...
class IngressUpdateIngressTlsOKResponse implements ResponseContainer
{
    /**
     ...
     * @return IngressUpdateIngressTlsOKResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): IngressUpdateIngressTlsOKResponse
    {
        ...
        $body = IngressUpdateIngressTlsOKResponseBody::buildFromInput($input->{'body'}, validate: $validate);
