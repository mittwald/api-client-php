...
class DeprecatedDnsRecordMxSetCustomRequest
{
     ...
     * @return DeprecatedDnsRecordMxSetCustomRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): DeprecatedDnsRecordMxSetCustomRequest
    {
    ...
    public function toJson(): array
    {
        ...
        $output['body'] = match (true) {
            ($this->body) instanceof RecordUnset, ($this->body) instanceof RecordMXCustom => $this->body->toJson(),
        };
    ...
    public function __clone()
    {
        $this->body = match (true) {
            ($this->body) instanceof RecordUnset, ($this->body) instanceof RecordMXCustom => $this->body,
        };
    }
