...
class DeprecatedDomainGetScreenshotForDomainRequest
{
     ...
     * @return DeprecatedDomainGetScreenshotForDomainRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): DeprecatedDomainGetScreenshotForDomainRequest
    {
        ...
        $body = DeprecatedDomainGetScreenshotForDomainRequestBody::buildFromInput($input->{'body'}, validate: $validate);
