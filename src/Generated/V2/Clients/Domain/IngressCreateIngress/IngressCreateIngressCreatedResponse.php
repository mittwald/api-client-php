...
class IngressCreateIngressCreatedResponse implements ResponseContainer
{
    /**
     ...
     * @return IngressCreateIngressCreatedResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): IngressCreateIngressCreatedResponse
    {
        ...
        $body = IngressCreateIngressCreatedResponseBody::buildFromInput($input->{'body'}, validate: $validate);
