...
class DeclareProcessChangeAuthcodeV2DeprecatedRequest
{
     ...
     * @return DeclareProcessChangeAuthcodeV2DeprecatedRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): DeclareProcessChangeAuthcodeV2DeprecatedRequest
    {
        ...
        $body = DeclareProcessChangeAuthcodeV2DeprecatedRequestBody::buildFromInput($input->{'body'}, validate: $validate);
