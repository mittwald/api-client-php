...
class DnsSetRecordSetManagedNoContentResponse implements ResponseContainer
{
    /**
     ...
     * @return DnsSetRecordSetManagedNoContentResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): DnsSetRecordSetManagedNoContentResponse
    {
        ...
        $body = DnsSetRecordSetManagedNoContentResponseBody::buildFromInput($input->{'body'}, validate: $validate);
