...
class GetScreenshotForDomainRequest
{
    ...
    /**
     * @var GetScreenshotForDomainRequestBody
     */
     ...
     */
    public function __construct(string $domainId, GetScreenshotForDomainRequestBody $body)
    {
    ...
    public static function buildFromInput(array|object $input, bool $validate = true): GetScreenshotForDomainRequest
    {
        ...
        $body = GetScreenshotForDomainRequestBody::buildFromInput($input->{'body'}, validate: $validate);
