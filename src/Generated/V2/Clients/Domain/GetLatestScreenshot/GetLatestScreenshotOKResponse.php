...
class GetLatestScreenshotOKResponse implements ResponseContainer
{
    /**
     ...
     * @return GetLatestScreenshotOKResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): GetLatestScreenshotOKResponse
    {
        ...
        $body = GetLatestScreenshotOKResponseBody::buildFromInput($input->{'body'}, validate: $validate);
