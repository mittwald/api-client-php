...
class CheckDomainTransferabilityForbiddenResponse implements ResponseContainer
{
    /**
     ...
     * @return CheckDomainTransferabilityForbiddenResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): CheckDomainTransferabilityForbiddenResponse
    {
        ...
        $body = CheckDomainTransferabilityForbiddenResponseBody::buildFromInput($input->{'body'}, validate: $validate);
