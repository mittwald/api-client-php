...
class DnsRecordASetManagedByIngressDeprecatedRequest
{
     ...
     * @return DnsRecordASetManagedByIngressDeprecatedRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): DnsRecordASetManagedByIngressDeprecatedRequest
    {
        ...
        $zoneId = $input->{'zoneId'};
        $body = DnsRecordASetManagedByIngressDeprecatedRequestBody::buildFromInput($input->{'body'}, validate: $validate);
