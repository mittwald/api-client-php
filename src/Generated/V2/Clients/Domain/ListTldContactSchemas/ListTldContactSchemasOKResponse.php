...
class ListTldContactSchemasOKResponse implements ResponseContainer
{
    /**
     ...
     * @return ListTldContactSchemasOKResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): ListTldContactSchemasOKResponse
    {
        ...
        $body = ListTldContactSchemasOKResponseBody::buildFromInput($input->{'body'}, validate: $validate);
