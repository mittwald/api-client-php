...
class DeprecatedDomainListDomainsRequest
{
    ...
    {
        $validator = new Validator();
        $validator->validate($domainSearchName, self::$schema['properties']['domainSearchName']);
        if (!$validator->isValid()) {
            throw new InvalidArgumentException($validator->getErrors()[0]['message']);
        }
     ...
     * @return DeprecatedDomainListDomainsRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): DeprecatedDomainListDomainsRequest
    {
