...
class CheckDomainRegistrabilityOKResponse implements ResponseContainer
{
    /**
     ...
     * @return CheckDomainRegistrabilityOKResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): CheckDomainRegistrabilityOKResponse
    {
        ...
        $body = CheckDomainRegistrabilityOKResponseBody::buildFromInput($input->{'body'}, validate: $validate);
