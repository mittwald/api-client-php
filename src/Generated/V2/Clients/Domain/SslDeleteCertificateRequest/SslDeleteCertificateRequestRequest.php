...
class SslDeleteCertificateRequestRequest
{
     ...
     * @return SslDeleteCertificateRequestRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): SslDeleteCertificateRequestRequest
    {
    ...
    public function buildUrl(): string
    {
        ...
        return '/v2/certificate-request/' . $certificateRequestId;
    }
