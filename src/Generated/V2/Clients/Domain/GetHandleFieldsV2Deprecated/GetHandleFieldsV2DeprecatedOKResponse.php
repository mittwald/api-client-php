...
class GetHandleFieldsV2DeprecatedOKResponse implements ResponseContainer
{
    /**
     ...
     * @return GetHandleFieldsV2DeprecatedOKResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): GetHandleFieldsV2DeprecatedOKResponse
    {
        ...
        $body = GetHandleFieldsV2DeprecatedOKResponseBody::buildFromInput($input->{'body'}, validate: $validate);
