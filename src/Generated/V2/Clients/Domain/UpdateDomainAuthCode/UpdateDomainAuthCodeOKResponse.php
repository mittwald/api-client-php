...
class UpdateDomainAuthCodeOKResponse implements ResponseContainer
{
    /**
     ...
     * @return UpdateDomainAuthCodeOKResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): UpdateDomainAuthCodeOKResponse
    {
        ...
        $body = UpdateDomainAuthCodeOKResponseBody::buildFromInput($input->{'body'}, validate: $validate);
