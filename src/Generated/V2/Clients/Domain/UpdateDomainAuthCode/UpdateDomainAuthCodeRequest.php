...
class UpdateDomainAuthCodeRequest
{
     ...
     * @return UpdateDomainAuthCodeRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): UpdateDomainAuthCodeRequest
    {
        ...
        $body = UpdateDomainAuthCodeRequestBody::buildFromInput($input->{'body'}, validate: $validate);
    ...
    public function buildUrl(): string
    {
        ...
        return '/v2/domains/' . $domainId . '/auth-code';
    }
