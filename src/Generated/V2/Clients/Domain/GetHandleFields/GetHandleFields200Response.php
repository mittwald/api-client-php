...
class GetHandleFields200Response
{
    ...
    /**
     * @var GetHandleFields200ResponseBody
     */
     ...
     */
    public function __construct(GetHandleFields200ResponseBody $body)
    {
        $this->body = $body;
    }
    ...
    public static function buildFromInput(array|object $input, bool $validate = true): GetHandleFields200Response
    {
        ...
        $body = GetHandleFields200ResponseBody::buildFromInput($input->{'body'}, validate: $validate);
