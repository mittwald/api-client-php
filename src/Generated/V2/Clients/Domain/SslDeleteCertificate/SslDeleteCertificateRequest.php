...
class SslDeleteCertificateRequest
{
     ...
     * @return SslDeleteCertificateRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): SslDeleteCertificateRequest
    {
    ...
    public function buildUrl(): string
    {
        ...
        return '/v2/certificate/' . $certificateId;
    }
