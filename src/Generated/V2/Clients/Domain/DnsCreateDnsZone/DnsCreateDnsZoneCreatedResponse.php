...
class DnsCreateDnsZoneCreatedResponse implements ResponseContainer
{
    /**
     ...
     * @return DnsCreateDnsZoneCreatedResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): DnsCreateDnsZoneCreatedResponse
    {
        ...
        $body = DnsCreateDnsZoneCreatedResponseBody::buildFromInput($input->{'body'}, validate: $validate);
