...
class DeclareProcessChangeHandlesV2DeprecatedOKResponse implements ResponseContainer
{
    /**
     ...
     * @return DeclareProcessChangeHandlesV2DeprecatedOKResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): DeclareProcessChangeHandlesV2DeprecatedOKResponse
    {
        ...
        $body = DeclareProcessChangeHandlesV2DeprecatedOKResponseBody::buildFromInput($input->{'body'}, validate: $validate);
