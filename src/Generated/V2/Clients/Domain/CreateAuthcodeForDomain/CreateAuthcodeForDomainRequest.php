...
class CreateAuthcodeForDomainRequest
{
     ...
     * @return CreateAuthcodeForDomainRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): CreateAuthcodeForDomainRequest
    {
    ...
    public function getUrl(): string
    {
        ...
        return '/v2/domains/' . $domainId . '/actions/create-authcode';
    }
