...
class CreateAuthcodeForDomain201Response
{
    ...
    /**
     * @var CreateAuthcodeForDomain201ResponseBody
     */
    private CreateAuthcodeForDomain201ResponseBody $body;
     ...
     */
    public function __construct(CreateAuthcodeForDomain201ResponseBody $body)
    {
        $this->body = $body;
    }
    ...
    public static function buildFromInput(array|object $input, bool $validate = true): CreateAuthcodeForDomain201Response
    {
        ...
        $body = CreateAuthcodeForDomain201ResponseBody::buildFromInput($input->{'body'}, validate: $validate);
