...
class CreateLegacyTariffChangeForbiddenResponse implements ResponseContainer
{
    /**
     ...
     * @return CreateLegacyTariffChangeForbiddenResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): CreateLegacyTariffChangeForbiddenResponse
    {
        ...
        $body = CreateLegacyTariffChangeForbiddenResponseBody::buildFromInput($input->{'body'}, validate: $validate);
