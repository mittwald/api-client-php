...
class ProjectGetPlansRequest
{
     ...
     * @return ProjectGetPlansRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): ProjectGetPlansRequest
    {
    ...
    public function buildUrl(): string
    {
        ...
        return '/v2/projects/' . $projectId . '/ai-hostings';
    }
