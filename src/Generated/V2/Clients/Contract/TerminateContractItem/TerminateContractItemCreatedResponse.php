...
class TerminateContractItemCreatedResponse implements ResponseContainer
{
    /**
     ...
     * @return TerminateContractItemCreatedResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): TerminateContractItemCreatedResponse
    {
        ...
        $body = TerminateContractItemCreatedResponseBody::buildFromInput($input->{'body'}, validate: $validate);
