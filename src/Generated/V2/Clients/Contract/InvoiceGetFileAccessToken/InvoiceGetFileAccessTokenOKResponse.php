...
class InvoiceGetFileAccessTokenOKResponse implements ResponseContainer
{
    /**
     ...
     * @return InvoiceGetFileAccessTokenOKResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): InvoiceGetFileAccessTokenOKResponse
    {
        ...
        $body = InvoiceGetFileAccessTokenOKResponseBody::buildFromInput($input->{'body'}, validate: $validate);
