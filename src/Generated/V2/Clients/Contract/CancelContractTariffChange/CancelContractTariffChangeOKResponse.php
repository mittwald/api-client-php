...
class CancelContractTariffChangeOKResponse implements ResponseContainer
{
    /**
     ...
     * @return CancelContractTariffChangeOKResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): CancelContractTariffChangeOKResponse
    {
        ...
        $body = CancelContractTariffChangeOKResponseBody::buildFromInput($input->{'body'}, validate: $validate);
