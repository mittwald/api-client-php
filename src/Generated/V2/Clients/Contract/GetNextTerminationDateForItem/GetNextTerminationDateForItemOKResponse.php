...
class GetNextTerminationDateForItemOKResponse implements ResponseContainer
{
    /**
     ...
     * @return GetNextTerminationDateForItemOKResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): GetNextTerminationDateForItemOKResponse
    {
        ...
        $body = GetNextTerminationDateForItemOKResponseBody::buildFromInput($input->{'body'}, validate: $validate);
