...
class CancelContractItemTermination200Response
{
    ...
    /**
     * @var CancelContractItemTermination200ResponseBody
     */
    private CancelContractItemTermination200ResponseBody $body;
     ...
     */
    public function __construct(CancelContractItemTermination200ResponseBody $body)
    {
        $this->body = $body;
    }
    ...
    public static function buildFromInput(array|object $input, bool $validate = true): CancelContractItemTermination200Response
    {
        ...
        $body = CancelContractItemTermination200ResponseBody::buildFromInput($input->{'body'}, validate: $validate);
