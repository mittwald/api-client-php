...
class GetDetailOfContractByMailAddressRequest
{
     ...
     * @return GetDetailOfContractByMailAddressRequest Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): GetDetailOfContractByMailAddressRequest
    {
    ...
    public function buildUrl(): string
    {
        ...
        return '/v2/mail-addresses/' . $mailAddressId . '/contract';
    }
