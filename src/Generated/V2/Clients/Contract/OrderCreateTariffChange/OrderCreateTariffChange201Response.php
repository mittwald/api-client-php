...
class OrderCreateTariffChange201Response
{
    ...
    /**
     * @var OrderCreateTariffChange201ResponseBody
     */
    private OrderCreateTariffChange201ResponseBody $body;
     ...
     */
    public function __construct(OrderCreateTariffChange201ResponseBody $body)
    {
        $this->body = $body;
    }
    ...
    public static function buildFromInput(array|object $input, bool $validate = true): OrderCreateTariffChange201Response
    {
        ...
        $body = OrderCreateTariffChange201ResponseBody::buildFromInput($input->{'body'}, validate: $validate);
