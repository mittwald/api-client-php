...
class OrderCreateTariffChangeCreatedResponse implements ResponseContainer
{
    /**
     ...
     * @return OrderCreateTariffChangeCreatedResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): OrderCreateTariffChangeCreatedResponse
    {
        ...
        $body = OrderCreateTariffChangeCreatedResponseBody::buildFromInput($input->{'body'}, validate: $validate);
