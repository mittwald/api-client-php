...
class DeprecatedNewsletterGetInfo200Response
{
    ...
    /**
     * @var DeprecatedNewsletterGetInfo200ResponseBody
     */
    private DeprecatedNewsletterGetInfo200ResponseBody $body;
     ...
     */
    public function __construct(DeprecatedNewsletterGetInfo200ResponseBody $body)
    {
        $this->body = $body;
    }
    ...
    public static function buildFromInput(array|object $input, bool $validate = true) : DeprecatedNewsletterGetInfo200Response
    {
        ...
        $body = DeprecatedNewsletterGetInfo200ResponseBody::buildFromInput($input->{'body'}, validate: $validate);
