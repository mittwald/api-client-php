...
class NewsletterSubscribeUserOKResponse implements ResponseContainer
{
    /**
     ...
     * @return NewsletterSubscribeUserOKResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): NewsletterSubscribeUserOKResponse
    {
        ...
        $body = NewsletterSubscribeUserOKResponseBody::buildFromInput($input->{'body'}, validate: $validate);
