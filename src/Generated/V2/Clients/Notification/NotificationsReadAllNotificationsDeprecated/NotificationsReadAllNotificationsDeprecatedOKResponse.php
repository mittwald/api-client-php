...
class NotificationsReadAllNotificationsDeprecatedOKResponse implements ResponseContainer
{
    /**
     ...
     * @return NotificationsReadAllNotificationsDeprecatedOKResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): NotificationsReadAllNotificationsDeprecatedOKResponse
    {
        ...
        $body = NotificationsReadAllNotificationsDeprecatedOKResponseBody::buildFromInput($input->{'body'}, validate: $validate);
