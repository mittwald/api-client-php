...
class UpdateCategoryOKResponse implements ResponseContainer
{
    /**
     ...
     * @return UpdateCategoryOKResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): UpdateCategoryOKResponse
    {
        ...
        $body = UpdateCategoryOKResponseBody::buildFromInput($input->{'body'}, validate: $validate);
