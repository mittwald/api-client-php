...
class CreateCategoryCreatedResponse implements ResponseContainer
{
    /**
     ...
     * @return CreateCategoryCreatedResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): CreateCategoryCreatedResponse
    {
        ...
        $body = CreateCategoryCreatedResponseBody::buildFromInput($input->{'body'}, validate: $validate);
