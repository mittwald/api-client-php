...
class RequestAvatarUploadUnauthorizedResponse implements ResponseContainer
{
    /**
     ...
     * @return RequestAvatarUploadUnauthorizedResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): RequestAvatarUploadUnauthorizedResponse
    {
        ...
        $body = RequestAvatarUploadUnauthorizedResponseBody::buildFromInput($input->{'body'}, validate: $validate);
