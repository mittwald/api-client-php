...
class IsCustomerLegallyCompetent200Response
{
    ...
    /**
     * @var IsCustomerLegallyCompetent200ResponseBody
     */
    private IsCustomerLegallyCompetent200ResponseBody $body;
     ...
     */
    public function __construct(IsCustomerLegallyCompetent200ResponseBody $body)
    {
        $this->body = $body;
    }
    ...
    public static function buildFromInput(array|object $input, bool $validate = true) : IsCustomerLegallyCompetent200Response
    {
        ...
        $body = IsCustomerLegallyCompetent200ResponseBody::buildFromInput($input->{'body'}, validate: $validate);
