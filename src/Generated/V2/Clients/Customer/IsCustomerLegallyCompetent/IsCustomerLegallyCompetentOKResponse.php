...
class IsCustomerLegallyCompetentOKResponse implements ResponseContainer
{
    /**
     ...
     * @return IsCustomerLegallyCompetentOKResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): IsCustomerLegallyCompetentOKResponse
    {
        ...
        $body = IsCustomerLegallyCompetentOKResponseBody::buildFromInput($input->{'body'}, validate: $validate);
