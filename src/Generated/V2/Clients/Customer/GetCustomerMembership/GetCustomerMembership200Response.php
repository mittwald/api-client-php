...
class GetCustomerMembership200Response
{
     ...
     */
    private \Mittwald\ApiClient\Generated\V2\Schemas\Membership\CustomerMembership $body;
     ...
     */
    public function __construct(\Mittwald\ApiClient\Generated\V2\Schemas\Membership\CustomerMembership $body)
    {
        $this->body = $body;
    }
     ...
     */
    public function getBody(): \Mittwald\ApiClient\Generated\V2\Schemas\Membership\CustomerMembership
    {
        return $this->body;
    }
     ...
     * @return self
     */
    public function withBody(\Mittwald\ApiClient\Generated\V2\Schemas\Membership\CustomerMembership $body): self
    {
        $clone = clone $this;
        $clone->body = $body;
    ...
    public static function buildFromInput(array|object $input, bool $validate = true): GetCustomerMembership200Response
    {
        ...
        $body = \Mittwald\ApiClient\Generated\V2\Schemas\Membership\CustomerMembership::buildFromInput($input->{'body'}, validate: $validate);
