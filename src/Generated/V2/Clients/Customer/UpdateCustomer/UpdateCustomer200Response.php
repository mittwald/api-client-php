...
class UpdateCustomer200Response
{
    ...
    /**
     * @var UpdateCustomer200ResponseBody
     */
    private UpdateCustomer200ResponseBody $body;
     ...
     */
    public function __construct(UpdateCustomer200ResponseBody $body)
    {
        $this->body = $body;
    }
    ...
    public static function buildFromInput(array|object $input, bool $validate = true): UpdateCustomer200Response
    {
        ...
        $body = UpdateCustomer200ResponseBody::buildFromInput($input->{'body'}, validate: $validate);
