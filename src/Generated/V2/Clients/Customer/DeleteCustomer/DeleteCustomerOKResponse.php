...
class DeleteCustomerOKResponse implements ResponseContainer
{
    /**
     ...
     * @return DeleteCustomerOKResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): DeleteCustomerOKResponse
    {
        ...
        $body = DeleteCustomerOKResponseBody::buildFromInput($input->{'body'}, validate: $validate);
