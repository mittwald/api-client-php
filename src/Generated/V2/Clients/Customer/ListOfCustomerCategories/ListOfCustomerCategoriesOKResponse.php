...
class ListOfCustomerCategoriesOKResponse implements ResponseContainer
{
    /**
     ...
     * @return ListOfCustomerCategoriesOKResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): ListOfCustomerCategoriesOKResponse
    {
        ...
        $body = ListOfCustomerCategoriesOKResponseBody::buildFromInput($input->{'body'}, validate: $validate);
