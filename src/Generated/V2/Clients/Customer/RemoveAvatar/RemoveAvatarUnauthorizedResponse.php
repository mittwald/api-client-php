...
class RemoveAvatarUnauthorizedResponse implements ResponseContainer
{
    /**
     ...
     * @return RemoveAvatarUnauthorizedResponse Created instance
     * @throws InvalidArgumentException
     */
    public static function buildFromInput(array|object $input, bool $validate = true): RemoveAvatarUnauthorizedResponse
    {
        ...
        $body = RemoveAvatarUnauthorizedResponseBody::buildFromInput($input->{'body'}, validate: $validate);
